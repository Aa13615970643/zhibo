    ...
    onLaunch: function () {
        ...
        if (!WebIM.conn.isOpened()) {
            ...
            if (!userName) {
                ...
                return this.globalData.register(userName, password);
            }

            let userInfo = JSON.parse(userName);
            this.globalData.autoLogin(userInfo.userName, password);
        } // 展示本地存储能力
        ...
        autoLogin(userName, password) {
            ...
            WebIM.conn.open({
                ...
                success(token) {
                    ...
                    console.log(self.globalData.token)
...
/* This stylesheet generated by Transfonter (https://transfonter.org) on November 12, 2017 6:51 AM */
@font-face {
 /*   font-family: 'fa';
...
.fa {
    ...
    font: normal normal normal 14px/1 fa !important;
    font-size: inherit;
    text-rendering: auto;
