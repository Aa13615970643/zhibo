<template>
    <view :style="'display:' + displayStyle + ';'" :class="'wx_loading_view ' + extClass" :animation="animationData" id="wx_loading_view">
        <view v-if="type === 'dot-white'" class="loading wx_dot_loading wx_dot_loading_white"></view>
...
export default {
    ...
    beforeMount: function attached() {
        var data = this;
        var animationInstance = uni.createAnimation({
    ...
    watch: {
        show: {
            handler: function observer(newValue) {
